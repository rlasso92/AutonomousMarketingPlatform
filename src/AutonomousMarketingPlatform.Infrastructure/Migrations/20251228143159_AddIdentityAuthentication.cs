    ...
    public partial class AddIdentityAuthentication : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "User",
                newName: "IX_User_TenantId_Email");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserTenants_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AutomationExecutions_RequestId",
                table: "AutomationExecutions",
                column: "RequestId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AutomationExecutions_TenantId",
                table: "AutomationExecutions",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_AutomationExecutions_TenantId_Status",
                table: "AutomationExecutions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTenants_TenantId_RoleId",
                table: "UserTenants",
